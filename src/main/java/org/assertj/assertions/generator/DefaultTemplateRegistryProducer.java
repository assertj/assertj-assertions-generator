...
public class DefaultTemplateRegistryProducer {
	...
	public static TemplateRegistry create(String templateDirectory) {
		...
		templateRegistry.register(new Template(Template.Type.IS_WITHOUT_NEG,
		...
		templateRegistry.register(new Template(Template.Type.IS_WRAPPER_WITHOUT_NEG,
				new File(templateDirectory, DEFAULT_IS_WRAPPER_WITHOUT_NEG_ASSERTION_TEMPLATE)));
